            ...
            <div class="col-12">
                ...
                <div class="card border">
                    ...
                    <div class="card-header">
                        ...
                        <h3><strong>Detalle de trabajador</strong></h3>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Id Direcciones: </strong> <%=trabajador.getDireccionId() %> </li>
                        <li class="list-group-item"><strong>Nombre: </strong> <%=trabajador.getNombre() %> </li>
                        <li class="list-group-item"><strong>Apellido P: </strong> <%=trabajador.getApellidoP() %> </li>
                        <li class="list-group-item"><strong>Apellido M: </strong> <%=trabajador.getApellidoM() %> </li>
                        <li class="list-group-item"><strong>Telefono: </strong> <%=trabajador.getTelefono() %> </li>
                        <li class="list-group-item"><strong>Sueldo: </strong> <%=trabajador.getSueldo() %> </li>
