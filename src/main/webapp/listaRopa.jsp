...
<%
    ...
    List<Ropa> ropa = (List<Ropa>) request.getAttribute("ropa");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <a href="<%=request.getContextPath()%>/ropa/alta"  class="btn btn-success"> Alta Ropa</a>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-striped" id="tablaRopa" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <% for(Ropa r: ropa) {%>
                                <tr>
                                    ...
                                    <td> <%=r.getIdRopa()%> </td>
                                    <td> <%=r.getPantalones()%> </td>
                                    <td> <%=r.getCamisas()%> </td>
                                    <td> <%=r.getVestidos()%> </td>
                                    <td> <%=r.getPlayeras()%> </td>
                                    <td> <%=r.getFaldas()%> </td>
                                    <td> <%=r.getPesoTotal()%> </td>
                                    <td> <%=r.getTotalPagar()%> </td>
                                    <td>

                                        <a href="<%=request.getContextPath()%>/ropa/detalle?id=<%=r.getIdRopa()%>" class="btn btn-success">
                                    ...
                                    <td>
                                        ...
                                        <a href="<%=request.getContextPath()%>/ropa/editar?id=<%=r.getIdRopa()%>" class="btn btn-primary">
                                    ...
                                    <td>
                                        ...
                                        <a href="<%=request.getContextPath()%>/ropa/eliminar?id=<%=r.getIdRopa()%>" class="btn btn-danger">
