 ...
 <nav class="navbar navbar-inverse">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="<%=request.getContextPath()%>/ropa/editar" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pantalones" id="pantalones" class="form-control" value="<%=ropa.getPantalones() != null? ropa.getPantalones(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="camisas" id="camisas" class="form-control" value="<%=ropa.getCamisas() != null? ropa.getCamisas(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="vestidos" id="vestidos" class="form-control" value="<%=ropa.getVestidos() != null? ropa.getVestidos(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="playeras" id="playeras" class="form-control" value="<%=ropa.getPlayeras() != null? ropa.getPlayeras(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="faldas" id="faldas" class="form-control" value="<%=ropa.getFaldas() != null? ropa.getFaldas(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pesoTotal" id="pesoTotal" class="form-control" value="<%=ropa.getPesoTotal() != null? ropa.getPesoTotal(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="totalPagar" id="totalPagar" class="form-control" value="<%=ropa.getTotalPagar() != null? ropa.getTotalPagar(): ""%>">
                        <%
