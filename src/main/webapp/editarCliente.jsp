            ...
            <form action="<%=request.getContextPath()%>/clientes/editar" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ropaId" id="ropaId" class="form-control" value="<%=cliente.getRopaId() != null? cliente.getRopaId(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telefono" id="telefono" class="form-control" value="<%=cliente.getTelefono() != null? cliente.getTelefono(): ""%>">
                        <%
