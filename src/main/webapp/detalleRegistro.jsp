            ...
            <div class="col-12">
                ...
                <div class="card border">
                    ...
                    <div class="card-header">
                        ...
                        <h3><strong>Detalle de Registro</strong></h3>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Id Cliente: </strong> <%=registro.getClienteId() %> </li>
                        <li class="list-group-item"><strong>Id Trabajador: </strong> <%=registro.getTrabajadorId() %> </li>
                        <li class="list-group-item"><strong>Fecha Recibido: </strong> <%=registro.getFechaRecibido() %> </li>
                        <li class="list-group-item"><strong>Fecha Entrega: </strong> <%=registro.getFechaEntrega() %> </li>
