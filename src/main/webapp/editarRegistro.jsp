...
<%
    ...
    String fechaR = registro.getFechaRecibido() != null ? registro.getFechaRecibido()
        .format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "";
    String fechaE = registro.getFechaEntrega() != null ? registro.getFechaEntrega()
        .format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : "";
            ...
            <form action="<%=request.getContextPath()%>/registros/alta" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="clienteId" id="clienteId" class="form-control" value="<%=registro.getClienteId() != null? chofer.getClienteId(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="trabajadorId" id="trabajadorId" class="form-control" value="<%=registro.getTrabajadorId() != null? registro.getTrabajadorId(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fechaRecibido" id="fechaRecibido" class="form-control" value="<%=fechaR%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fechaEntrega" id="fechaEntrega" class="form-control" value="<%=fechaE%>">
                        <%
