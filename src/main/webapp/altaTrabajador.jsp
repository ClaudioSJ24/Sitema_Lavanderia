            ...
            <form action="<%=request.getContextPath()%>/trabajadores/alta" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="direccionId" id="direccionId" class="form-control" value="${param.direccionId}">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apellidoP" id="apellidoP" class="form-control" value="${param.apellidoP}">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apellidoM" id="apellidoM" class="form-control" value="${param.apellidoM}">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sueldo" id="sueldo" class="form-control" value="${param.sueldo}">
                        <%
