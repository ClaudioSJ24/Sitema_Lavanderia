            ...
            <div class="col-12">
                ...
                <div class="card border">
                    ...
                    <div class="card-header">
                        ...
                        <h3><strong>Detalle de Ropa</strong></h3>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Pantalones: </strong> <%=ropa.getPantalones() %> </li>
                        <li class="list-group-item"><strong>Camisas </strong> <%=ropa.getCamisas() %> </li>
                        <li class="list-group-item"><strong>Vestidos: </strong> <%=ropa.getVestidos() %> </li>
                        <li class="list-group-item"><strong>Playeras: </strong> <%=ropa.getPlayeras() %> </li>
                        <li class="list-group-item"><strong>Faldas: </strong> <%=ropa.getFaldas() %> </li>
                        <li class="list-group-item"><strong>Peso Total: </strong> <%=ropa.getPesoTotal() %> </li>
                        <li class="list-group-item"><strong>Total a Pagar: </strong> <%=ropa.getTotalPagar() %> </li>
